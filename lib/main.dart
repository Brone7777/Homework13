...
import 'package:foods/pages/food/food_order_page.dart';
import 'package:foods/pages/login/login_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      //home: LoginPage(),
      routes: {
        LoginPage.routeName: _test,
        //ใช้แทน (context) => const LoginPage(), ได้ เมื่อต้องมีการ calculate ก่อนที่จะเปลี่ยน page
        HomePage.routeName: (context) => const HomePage(),
        //ใช้ /login ในการ navigate แทนชื่อ class (ตั้งชื่อเป็นอะไรก็ได้ แต่ส่วนใหญ่ตั้งเป็น path)
